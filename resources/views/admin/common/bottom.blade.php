<section class="newsletter theme-bg" style="background-image:url('{{ asset('public/admin/assets/img/bg-new.png') }}')">
    <div class="container">
        <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-4">
                <a href="index.html"><img class="footer-logo" src="{{ asset('public/admin/assets/img/logo.png') }}"
                        alt=""></a>
...
<script src="{{ asset('public/admin/assets/plugins/bootstrap/js/bootsnav.js') }}"></script>
<script src="{{ asset('public/admin/assets/js/viewportchecker.js') }}"></script>
<script src="{{ asset('public/admin/assets/js/slick.js') }}"></script>
<script src="{{ asset('public/admin/assets/plugins/bootstrap/js/wysihtml5-0.3.0.js') }}"></script>
<script src="{{ asset('public/admin/assets/plugins/bootstrap/js/bootstrap-wysihtml5.js') }}"></script>
<script src="{{ asset('public/admin/assets/plugins/aos-master/aos.js') }}"></script>
<script src="{{ asset('public/admin/assets/plugins/nice-select/js/jquery.nice-select.min.js') }}"></script>
