...
<div class="page-title">
  <div class="container">
    <div class="page-caption">
      <h2>Brose Job</h2>
      <p><a href="{{ url('/') }}" title="Home">Home</a> <i class="ti-angle-double-right"></i> Browse Job</p>
    </div>
  </div>
</div>
<!-- ======================= End Page Title ===================== --> 
    ...
    <div class="row"> 
      ...
      <div class="col-md-9 col-sm-7">
        ...
        <div class="job-verticle-list">
          <div class="vertical-job-card">
            <div class="vertical-job-header">
              <div class="vrt-job-cmp-logo"> <a href="{{ url('/job-detail') }}"><img src="{{ asset('public/web/assets/img/company_logo_1.png')}}" class="img-responsive" alt="" /></a> </div>
              <h4><a href="{{ url('/job-detail') }}">Apple LTD</a></h4>
            ...
            <div class="vertical-job-body">
              <div class="row">
                ...
                <div class="col-md-3 col-sm-12 col-xs-12">
                  <div class="vrt-job-act"> <a href="#" data-toggle="modal" data-target="#apply-job" class="btn-job theme-btn job-apply">Apply Now</a> <a href="{{ url('/job-detail') }}" title="" class="btn-job light-gray-btn">View Job</a> </div>
                </div>
              </div>
            </div>            
          </div>
        ...
        <div class="job-verticle-list">
          <div class="vertical-job-card">
            <div class="vertical-job-header">
              <div class="vrt-job-cmp-logo"> <a href="{{ url('/job-detail') }}"><img src="{{ asset('public/web/assets/img/company_logo_2.png')}}" class="img-responsive" alt="" /></a> </div>
              <h4><a href="{{ url('/job-detail') }}">Google LTD</a></h4>
              <span class="com-tagline">Software Development</span> <span class="pull-right vacancy-no">No. <span class="v-count">2</span></span> 
			</div>
            <div class="vertical-job-body">
              <div class="row">
        ...
        <div class="job-verticle-list">
          <div class="vertical-job-card">
            <div class="vertical-job-header">
              <div class="vrt-job-cmp-logo"> <a href="{{ url('/job-detail') }}"><img src="{{ asset('public/web/assets/img/company_logo_3.png')}}" class="img-responsive" alt="" /></a> </div>
              <h4><a href="{{ url('/job-detail') }}">Laxol LTD</a></h4>
        ...
        <div class="job-verticle-list">
          <div class="vertical-job-card">
            <div class="vertical-job-header">
              <div class="vrt-job-cmp-logo"> <a href="{{ url('/job-detail') }}"><img src="{{ asset('public/web/assets/img/company_logo_4.png')}}" class="img-responsive" alt="" /></a> </div>
              <h4><a href="{{ url('/job-detail') }}">Sirix LTD</a></h4>
        ...
        <div class="job-verticle-list">
          <div class="vertical-job-card">
            <div class="vertical-job-header">
              <div class="vrt-job-cmp-logo"> <a href="{{ url('/job-detail') }}"><img src="{{ asset('public/web/assets/img/company_logo_5.png')}}" class="img-responsive" alt="" /></a> </div>
              <h4><a href="{{ url('/job-detail') }}">Indico LTD</a></h4>
