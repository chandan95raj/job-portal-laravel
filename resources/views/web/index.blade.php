...
<!-- ======================= Start Banner ===================== -->
<div class="utf_main_banner_area" style="background-image:url('{{ asset('public/web/assets/img/slider_bg.jpg')}}');" data-overlay="8">
  <div class="container">
...
<section class="padd-top-80 padd-bot-80">
  <div class="container"> 
        ...
        <div class="row"> 
          ...
          <div class="col-md-3 col-sm-6">
            <div class="utf_grid_job_widget_area"> <span class="job-type full-type">Full Time</span>
              ...
              <div class="u-content">
                <div class="avatar box-80"> <a href="{{ url('/employer-detail') }}"> <img class="img-responsive" src="{{ asset('public/web/assets/img/company_logo_1.png')}}" alt=""> </a> </div>
                <h5><a href="{{ url('/employer-detail') }}">Product Redesign</a></h5>
                <p class="text-muted">2708 Scenic Way, IL 62373</p>
              </div>
              <div class="utf_apply_job_btn_item"> <a href="{{ url('/job-detail') }}" class="btn job-browse-btn btn-radius br-light">Apply Now</a> </div>
            </div>
          </div>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="utf_grid_job_widget_area"> <span class="job-type full-type">Full Time</span>
              ...
              <div class="u-content">
                <div class="avatar box-80"> <a href="{{ url('/employer-detail') }}"> <img class="img-responsive" src="{{ asset('public/web/assets/img/company_logo_2.png')}}" alt=""> </a> </div>
                <h5><a href="{{ url('/employer-detail') }}">New Product Mockup</a></h5>
                <p class="text-muted">2708 Scenic Way, IL 62373</p>
              </div>
              <div class="utf_apply_job_btn_item"> <a href="{{ url('/job-detail') }}" class="btn job-browse-btn btn-radius br-light">Apply Now</a> </div>
            </div>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="utf_grid_job_widget_area"> <span class="job-type part-type">Part Time</span>
              ...
              <div class="u-content">
                <div class="avatar box-80"> <a href="{{ url('/employer-detail') }}"> <img class="img-responsive" src="{{ asset('public/web/assets/img/company_logo_3.png')}}" alt=""> </a> </div>
                <h5><a href="{{ url('/employer-detail') }}">Custom Php Developer</a></h5>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="utf_grid_job_widget_area"> <span class="job-type part-type">Part Time</span>
              ...
              <div class="u-content">
                <div class="avatar box-80"> <a href="{{ url('/employer-detail') }}"> <img class="img-responsive" src="{{ asset('public/web/assets/img/company_logo_4.png')}}" alt=""> </a> </div>
                <h5><a href="{{ url('/employer-detail') }}">Wordpress Developer</a></h5>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="utf_grid_job_widget_area"> <span class="job-type internship-type">Internship</span>
              ...
              <div class="u-content">
                <div class="avatar box-80"> <a href="{{ url('/employer-detail') }}"> <img class="img-responsive" src="{{ asset('public/web/assets/img/company_logo_5.png')}}" alt=""> </a> </div>
                <h5><a href="{{ url('/employer-detail') }}">Web Maintenence</a></h5>
                <p class="text-muted">2708 Scenic Way, IL 62373</p>
              </div>
              <div class="utf_apply_job_btn_item"> <a href="{{ url('/job-detail') }}" class="btn job-browse-btn btn-radius br-light">Apply Now</a> </div>
            </div>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="utf_grid_job_widget_area"> <span class="job-type part-type">Part Time</span>
              ...
              <div class="u-content">
                <div class="avatar box-80"> <a href="{{ url('/employer-detail') }}"> <img class="img-responsive" src="{{ asset('public/web/assets/img/company_logo_6.png')}}" alt=""> </a> </div>
                <h5><a href="{{ url('/employer-detail') }}">Photoshop Designer</a></h5>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="utf_grid_job_widget_area"> <span class="job-type full-type">Full Time</span>
              ...
              <div class="u-content">
                <div class="avatar box-80"> <a href="{{ url('/employer-detail') }}"> <img class="img-responsive" src="{{ asset('public/web/assets/img/company_logo_7.png')}}" alt=""> </a> </div>
                <h5><a href="{{ url('/employer-detail') }}">HTML5 & CSS3 Coder</a></h5>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="utf_grid_job_widget_area"> <span class="job-type part-type">Part Time</span>
              ...
              <div class="u-content">
                <div class="avatar box-80"> <a href="{{ url('/employer-detail') }}"> <img class="img-responsive" src="{{ asset('public/web/assets/img/company_logo_8.png')}}" alt=""> </a> </div>
                <h5><a href="{{ url('/employer-detail') }}">.Net Developer</a></h5>
        ...
        <div class="row"> 
          ...
          <div class="col-md-3 col-sm-6">
            <div class="utf_grid_job_widget_area"> <span class="job-type full-type">Full Time</span>
              ...
              <div class="u-content">
                <div class="avatar box-80"> <a href="{{ url('/employer-detail') }}"> <img class="img-responsive" src="{{ asset('public/web/assets/img/company_logo_4.png')}}" alt=""> </a> </div>
                <h5><a href="{{ url('/employer-detail') }}">Java Developer</a></h5>
                <p class="text-muted">2708 Scenic Way, IL 62373</p>
              </div>
              <div class="utf_apply_job_btn_item"> <a href="{{ url('/job-detail') }}" class="btn job-browse-btn btn-radius br-light">Apply Now</a> </div>
            </div>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="utf_grid_job_widget_area"> <span class="job-type part-type">Part Time</span>
              ...
              <div class="u-content">
                <div class="avatar box-80"> <a href="{{ url('/employer-detail') }}"> <img class="img-responsive" src="{{ asset('public/web/assets/img/company_logo_6.png')}}" alt=""> </a> </div>
                <h5><a href="{{ url('/employer-detail') }}">Front End Designer</a></h5>
                <p class="text-muted">3815 Forest Drive, Alexandria</p>
              </div>
              <div class="utf_apply_job_btn_item"> <a href="{{ url('/job-detail') }}" class="btn job-browse-btn btn-radius br-light">Apply Now</a> </div>
            </div>
    ...
    <div class="col-md-12 mrg-top-20 text-center">
      <a href="{{ url('/jobs') }}" class="btn theme-btn btn-m">Browse All Jobs</a>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="row">
		<div class="col-md-12">
		  ...
		  <div class="col-md-12 mrg-top-20 text-center">
			<a href="{{ url('/browse-category') }}" class="btn theme-btn btn-m">View All Categories</a>
		  </div>
	  </div>
    </div>
  </div>
