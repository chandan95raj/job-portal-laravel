...
<div class="page-title">
	<div class="container">
	  <div class="page-caption">
		<h2>Resume Detail</h2>
		<p><a href="{{ url('/') }}" title="Home">Home</a> <i class="ti-angle-double-right"></i> Resume Detail</p>		
	  </div>    
	</div>
</div>
<!-- ======================= End Page Title ===================== --> 
      ...
      <div class="col-md-8 col-sm-7">
        <div class="detail-wrapper">
          <div class="detail-wrapper-body">
            <div class="row">
				<div class="col-md-4 text-center user_profile_img mrg-bot-30"> <img src="{{ asset('public/web/assets/img/client-1.jpg')}}" class="img-circle width-100" alt=""/>
				  <h4 class="meg-0">Alden Smith</h4>
				  <span>Front End Designer</span> 
				</div>
				<div class="col-md-8 user_job_detail">
				  <div class="col-md-12 mrg-bot-10"> <i class="ti-location-pin padd-r-10"></i>2726 Shinn, New York </div>
				  <div class="col-md-12 mrg-bot-10"> <i class="ti-email padd-r-10"></i>info@specbits.com </div>
				  <div class="col-md-12 mrg-bot-10"> <i class="ti-mobile padd-r-10"></i>+91 7004525294 </div>
				  ...
				  <div class="col-md-12 mrg-bot-10"> <span class="skill-tag">css</span> <span class="skill-tag">HTML</span> <span class="skill-tag">Photoshop</span> </div>
				</div>
			</div>
          </div>
        </div>
        ...
        <div class="sidebar"> 
		  <div class="widget-boxed"> 	
			  <div class="text-center">
				  <button type="submit" class="btn btn-m btn-danger">Download Resume</button>
			  </div>
		  </div>
          <div class="widget-boxed">
            ...
            <div class="widget-boxed-body">
              <div class="side-list no-border">
                <ul>
                  ...
                  <li><i class="ti-world padd-r-10"></i>https://specbits.com/</li>
                  <li><i class="ti-mobile padd-r-10"></i>+91 7004525294</li>
                  <li><i class="ti-email padd-r-10"></i>info@specbits.com</li>
